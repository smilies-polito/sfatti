...
end entity rom_75x75_inhlif1;

architecture behavior of rom_75x75_inhlif1 is


    component rom_75x75_inhlif1_ip is
        port (
            clka : in std_logic;
            addra : in std_logic_vector(6 downto 0);
...
begin
    ...
    rom_75x75_inhlif1_ip_instance : rom_75x75_inhlif1_ip
        port map(
            clka => clka,
            addra => addra,
            douta => douta
