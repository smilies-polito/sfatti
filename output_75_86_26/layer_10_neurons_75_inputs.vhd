...
entity layer_10_neurons_75_inputs is
    generic (
        n_exc_inputs : integer := 75;
...
end entity layer_10_neurons_75_inputs;

architecture behavior of layer_10_neurons_75_inputs is
    ...
    component multi_input_75_exc_10_inh is
        generic (
            n_exc_inputs : integer := 75;
            n_inh_inputs : integer := 10;
            exc_cnt_bitwidth : integer := 7;
    ...
    component rom_75x10_exclif2 is
        port (
            clka : in std_logic;
...
begin
    ...
    multi_input_control : multi_input_75_exc_10_inh
        generic map(
