...
architecture behavior of layer_75_neurons_784_inputs is
    ...
    constant v_th_0 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_4 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_5 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_6 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_7 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_8 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_9 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_a : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_b : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_c : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_d : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_e : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_f : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_10 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_11 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_12 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_13 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_14 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_15 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_16 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_17 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_18 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_19 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1a : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1b : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1c : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1d : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1e : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_1f : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_20 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_21 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_22 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_23 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_24 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_25 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_26 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_27 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_28 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_29 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2a : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2b : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2c : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2d : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2e : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_2f : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_30 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_31 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_32 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_33 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_34 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_35 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_36 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_37 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_38 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_39 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3a : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3b : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3c : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3d : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3e : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_3f : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_40 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_41 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_42 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_43 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_44 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_45 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_46 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_47 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_48 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_49 : signed(neuron_bit_width-1 downto 0) := "00100000";
    constant v_th_4a : signed(neuron_bit_width-1 downto 0) := "00100000";
