...
architecture behavior of network is
    ...
    component layer_75_neurons_784_inputs is
        generic (
    ...
    component layer_10_neurons_75_inputs is
        generic (
    ...
    signal layer_0_feedback : std_logic_vector(74 downto 0);
...
begin
    ...
    layer_0 : layer_75_neurons_784_inputs
        generic map(
            n_exc_inputs => 784,
            n_inh_inputs => 75,
            exc_cnt_bitwidth => 10,
    ...
    layer_1 : layer_10_neurons_75_inputs
        generic map(
            n_exc_inputs => 75,
            n_inh_inputs => 10,
            exc_cnt_bitwidth => 7,
